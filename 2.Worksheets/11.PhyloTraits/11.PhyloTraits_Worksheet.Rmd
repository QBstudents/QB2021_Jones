...
```{r}
fungal.alignment <- read.alignment(file = "./fungal.clustal_num", format = "fasta")

fungal.alignment <- read.alignment("fungal.fasta", format = "FASTA")

#Converting alignment into a DNAbin object
f.DNAbin <- as.DNAbin(fungal.alignment)

#Visualizing
image.DNAbin(f.DNAbin, cex.lab = .50)
```
